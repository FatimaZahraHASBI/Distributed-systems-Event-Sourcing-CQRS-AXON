...
public class UpdateOrderLineCommand extends BaseCommand<String> {
    ...
    public UpdateOrderLineCommand(String commandId, int quantité, double prix_unitaire, double remise, String idOrder, String idProduct) {
        super(commandId);
