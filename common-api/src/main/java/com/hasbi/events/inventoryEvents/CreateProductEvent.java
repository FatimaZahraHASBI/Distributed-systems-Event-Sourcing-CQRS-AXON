...
public class CreateProductEvent extends BaseEvent<String> {
    ...
    public CreateProductEvent(String commandId, String nom, double prix, int quantite, ProductState etat, String idCategorie) {
        super(commandId);
        this.nom = nom;
        this.prix = prix;
