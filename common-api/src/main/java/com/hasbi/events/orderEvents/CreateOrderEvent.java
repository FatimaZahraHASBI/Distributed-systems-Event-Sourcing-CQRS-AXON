...
public class CreateOrderEvent extends BaseCommand<String>{
    ...
    public CreateOrderEvent(String commandId, Date dateCommande, Date dateLivraison, String adresseLivraison, CommandStatus status, String customerId) {
        super(commandId);
