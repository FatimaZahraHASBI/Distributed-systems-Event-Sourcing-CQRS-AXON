...
public class UpdateOrderLineEvent extends BaseEvent<String> {
    ...
    public UpdateOrderLineEvent(String commandId, int quantité, double prix_unitaire, double remise, String idOrder, String idProduct) {
        super(commandId);
